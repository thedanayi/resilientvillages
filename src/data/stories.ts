...
export const stories: Story[] = [
  ...
  },
  {
    ...
    summary: "A new solar borehole brings health and time back to the women of Chirumhanzu District.",
    challenge: "Women and girls in Chirumhanzu spent up to 5 hours a day walking to a distant river to collect water, which was often contaminated, leading to frequent outbreaks of waterborne diseases.",
